          ...
          {final?.lessonPlan.map((item) =>
            ...
            <TouchableOpacity
              ...
              <View style={{ flexDirection: "row", margin: 10 }}>
                ...
                <Text style={{ color: "black", fontSize: 13, fontWeight: "700", marginLeft: 60 }}>Status</Text><Text style={{ color: "#F38216", fontSize: 14, fontWeight: "500", marginLeft: 5 }}>{item?.Status}</Text>
              </View>
            </TouchableOpacity>
          )
          }
