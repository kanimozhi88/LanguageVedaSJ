...
const StudentCourseSelect = ({batchId, courseName}) => {
  ...
  const totalProgress = final?.lessonPlan?.reduce(
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <ShowMoreText
          text={final?.courseSchedules[0]?.courseDescription}
        ...
        <View
          ...
          <View style={{flexDirection: 'row', marginHorizontal: 40}}>
            ...
            />
            <Text style={{color: '#979797', margin: 2}}>
              {final?.courseSchedules[0]?.Months} Months
            </Text>
          </View>
        </View>
